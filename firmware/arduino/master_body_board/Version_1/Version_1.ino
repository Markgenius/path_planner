...
bool LL_sensor = LOW;
bool RR_sensor = LOW;
#define delay_time_analyse_cross_angle   15              //unit is micro second
...
#define RL_digit_delaytime 20                     //20the delay_time of "cross_sensor" when the "analyse_cross_angle_front_sensors" == HIGH
